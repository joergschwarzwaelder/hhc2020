...
In the HTML comments are the 624 random values, which were generated prior to create the seed for the current game.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzMzNjgxNDMwLC0yMDE3MzE4MjY5LDczMD
k5ODExNl19
-->